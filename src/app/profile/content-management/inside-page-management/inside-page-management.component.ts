...
@Component({
  selector: 'app-inside-page-management',
  templateUrl: './inside-page-management.component.html',
  styleUrls: ['./inside-page-management.component.scss']
})
export class InsidePageManagementComponent implements OnInit {
  ...
  onClickReset() {
    Swal.fire({
      title: 'Are you sure?',
      text: "Admin Page Colors will be set to default.",
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        this.customSpaSettingsService.updateAdminHeaderAndFooterColor(this.defaultHeaderColor, this.defaultFooterColor).subscribe(result => {
          ...
          Swal.fire('Reset!', 'Admin Page has been reset.', 'success')
        }, (err) => {
  ...
  onClickSave() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.customSpaSettingsService.updateAdminHeaderAndFooterColor(this.headerColor, this.footerColor).subscribe(result => {
